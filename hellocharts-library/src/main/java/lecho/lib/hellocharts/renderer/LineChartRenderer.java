...
public class LineChartRenderer extends AbstractChartRenderer {
    ...
    public void onChartSizeChanged() {
        System.out.println("======>>>>>onChartSizeChanged");
    ...
    public void onChartDataChanged() {
        System.out.println("======>>>>>onChartDataChanged");
    ...
    public void onChartViewportChanged() {
        System.out.println("======>>>>>onChartViewportChanged");
    ...
    public void drawUnclipped(Canvas canvas) {
        System.out.println("======>>>>>drawUnclipped");
        final LineChartData data = dataProvider.getLineChartData();
        int lineIndex = 0;
        for (Line line : data.getLines()) {
    ...
    private boolean checkIfShouldDrawPoints(Line line) {
        System.out.println("======>>>>>checkIfShouldDrawPoints");
    ...
    private void calculateMaxViewport() {
        ...
        System.out.println("======>>>>>calculateMaxViewport");
        for (Line line : data.getLines()) {
    ...
    private int calculateContentRectInternalMargin() {
        ...
        System.out.println("======>>>>>calculateContentRectInternalMargin");
        final LineChartData data = dataProvider.getLineChartData();
        for (Line line : data.getLines()) {
            if (checkIfShouldDrawPoints(line)) {
    ...
    private void drawSquarePath(Canvas canvas, final Line line) {
        prepareLinePaint(line);
        System.out.println("======>>>>>drawSquarePath");
        int valueIndex = 0;
    ...
    private void drawSmoothPath(Canvas canvas, final Line line) {
        prepareLinePaint(line);
        System.out.println("======>>>>>drawSmoothPath");
    ...
    private void prepareLinePaint(final Line line) {
        System.out.println("======>>>>>prepareLinePaint");
    ...
    private void highlightPoint(Canvas canvas, Line line, PointValue pointValue, float rawX, float rawY, int lineIndex,
                                int valueIndex) {
        System.out.println("======>>>>>highlightPoint");
